...
final class ServerService {
  ...
  Future<core.XRPCResponse<CreatedInviteCode>> createInviteCode({
    ...
    body: {'useCount': useCount, 'forAccount': forAccount},
  ...
  Future<core.XRPCResponse<AppPassword>> createAppPassword({
    ...
    body: {'name': name, 'privileged': privileged},
  ...
  Future<core.XRPCResponse<core.EmptyData>> requestEmailConfirmation() async =>
      await _ctx.post(ns.comAtprotoServerRequestEmailConfirmation);
  ...
  Future<core.XRPCResponse<core.EmptyData>> updateEmail({
    ...
    body: {'email': email, 'emailAuthFactor': emailAuthFactor, 'token': token},
  );

  /// https://atprotodart.com/docs/lexicons/com/atproto/server/reserveSigningKey
  Future<core.XRPCResponse<SigningKey>> reserveSigningKey() async => await _ctx
      .post(ns.comAtprotoServerReserveSigningKey, to: SigningKey.fromJson);
  ...
  Future<core.XRPCResponse<ServiceAuthToken>> getServiceAuth({
    ...
    headers: headers,
    parameters: {'aud': aud, 'exp': exp, 'lxm': lxm.toString()},
  ...
  Future<core.XRPCResponse<core.EmptyData>> deactivateAccount({
    ...
    body: {'deleteAfter': _ctx.toUtcIso8601String(deleteAfter)},
  );
  ...
  Future<core.XRPCResponse<core.EmptyData>> activateAccount() async =>
      await _ctx.post(ns.comAtprotoServerActivateAccount);
}
